...
/**
*	Adicionar o número selecionado para o cálculo posteriomente
*	@return void
*/
...
*	a operação anterior e define uma nova operação.
*	@param String operacao
*	@return avoid
*/
definirOperacao(operacao: string): void {
	//just define the operation case don't exists one./
	if (this.operacao === null){
		this.operacao = operacao;
		return;
	}
	/*
	* 	case defined operation is number 2 selected
	*	calculs up	
	*/
	if(this.numero2 !== null){
		this.resultado = this.calculadoraService.calcular(
